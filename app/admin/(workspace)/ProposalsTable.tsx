  ...
  return (
    <div className="px-6 py-6 sm:px-8">
      <div className={`${brand.panel} overflow-hidden`}>
        ...
        {sorted.length > 0 && (
          <div className="flex items-center gap-4 border-b border-hairline bg-neutral-tint/40 px-5 py-2.5">
            ...
            <div className="flex flex-col items-center px-5 py-20 text-center">
              ...
              {proposals.length > 0 && hasFilters && (
                <button
                  type="button"
                  onClick={handleClear}
                  className="mt-4 text-xs font-semibold text-brand-green hover:text-brand-green/80"
                >
                  Clear filters
                </button>
              )}
